#ifndef __nobodyxu_concept_check_concepts_type_properties_operations_is_swappable_v_HPP__
# define __nobodyxu_concept_check_concepts_type_properties_operations_is_swappable_v_HPP__

# include "../../../detector_core.hpp"
# include "../../../utility.hpp"
# include "../../is_referenceable_v.hpp"

namespace nxwheels::concept_check::is_swable_impl {
template <class T1, class T2> using swap_ret_t = decltype( swap(declval<T1>(), declval<T2>()) );
} /* nxwheels::concept_check::is_sw_impl */

namespace nxwheels::concept_check {
template <class T1, class T2> constexpr const static inline bool is_swappable_with_impl_v = is_detected_v<is_swable_impl::swap_ret_t, T1, T2>;
/*!
...
template <class T1, class T2> constexpr const static inline bool is_nothrow_swappable_with_impl_v = _is_nothrow_swappable_with_impl_v<T1, T2> && _is_nothrow_swappable_with_impl_v<T2, T1>;
/*!
