#ifndef __nobodyxu_concept_check_concepts_type_properties_operations_is_self_decrementable_v_HPP__
# define __nobodyxu_concept_check_concepts_type_properties_operations_is_self_decrementable_v_HPP__
...
template <class T> constexpr const static inline bool is_post_decrementable_v = is_detected_implicitly_convertible_v<remove_reference_t<T>, post_decremented_t, T>;
